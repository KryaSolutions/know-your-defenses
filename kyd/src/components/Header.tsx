...
const Header = () => {
    ...
    return (
        <div className="relative overflow-hidden bg-[var(--brand-blue)] text-white min-h-screen">
            <div className="relative max-w-6xl mx-auto px-4 sm:px-6 pt-32 pb-12">
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    <div className="space-y-6">
                        <div className="space-y-3">
                            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-medium leading-tight text-white">
                                Know Your Defenses
                            </h1>

                            <p className="text-base sm:text-lg text-[var(--brand-grey)] leading-relaxed max-w-xl">
                        ...
                        <div className="grid grid-cols-2 gap-2 max-w-xl">
                            ...
                            >
                                ...
                                <span className="text-xs text-[var(--brand-grey)]">
                    ...
                    <div className="relative">
                        <div className="relative mx-auto w-64 h-64 lg:w-80 lg:h-80 flex items-center justify-center">
                            ...
                            >
                                <div className="p-3 bg-orange-500/20 rounded-lg backdrop-blur-sm border border-orange-400/30">
                                    <Shield className="w-6 h-6 text-[var(--brand-orange)]" />
                                </div>
                            </div>
                        </div>

                        <div className="absolute -bottom-4 left-4 p-4 bg-white/10 rounded-lg backdrop-blur-sm border border-white/20 transform rotate-3 transition-all duration-300 hover:scale-105 hover:rotate-0">
                        ...
                        <div className="absolute -top-4 right-4 p-4 bg-white/10 rounded-lg backdrop-blur-sm border border-white/20 transform -rotate-3 transition-all duration-300 hover:scale-105 hover:rotate-0">
